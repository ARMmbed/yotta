...
## Installing On OS X
To install yotta on OS X you can either use the [yotta.app](https://github.com/ARMmbed/yotta_osx_installer/releases/latest) or install all the dependencies and yotta manually.
## yotta.app
