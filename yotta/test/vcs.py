...
class TestGit(unittest.TestCase):
    def setUp(self):
        ...
        if not len(out):
            ...
            out, err = child.communicate()
        self.working_copy = vcs.Git.cloneToTemporaryDir(Test_Repo_git)
...
# FIXME: refactor common code in a single base class
class TestHg(unittest.TestCase):
    def setUp(self):
        ...
        self.working_copy = vcs.HG.cloneToTemporaryDir(Test_Repo_hg)
        self.assertTrue(self.working_copy)
