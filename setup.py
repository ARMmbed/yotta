...
setup(
    ...
    install_requires=['semantic_version>=2.3.1,<3', 'restkit>=4.2,<5', 'PyGithub>1.25,<2', 'colorama>=0.3,<0.4', 'hgapi>=1.7,<2', 'Jinja2>2.7.0', 'PyCrypto>=2.5,<3', 'PyJWT>=0.3,<0.4', 'pathlib>=1.0.1'] + platform_deps
)
